...
- Cloud Tasks / Pub/Sub / Redis / any new external infrastructure. Per-turn push dispatch ("P3") is a committed follow-up roadmap that starts only after this handoff ships — do NOT build any part of it here. Scope and sequencing live in `TODO.md` ("Roadmap — P3 auto scale: Cloud Tasks per-turn dispatch").
