...
- Cloud Tasks / Pub/Sub / Redis / any new external infrastructure. Per-turn push dispatch ("P3") was evaluated and deliberately deferred — triggers and future scope are recorded in `TODO.md` ("Deferred — P3 Cloud Tasks per-turn dispatch and autoscaling").
